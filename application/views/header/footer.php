                    ...
                    <div class="row">
                        <div class="col-sm-4 col-md-12">
                            <div class="footer-logo">
                                <a href="index.html"><img src="<?php echo base_url('assets/theme/images/logo.png')?>" alt=""></a>
                            </div>
                        </div>
                        <div class="col-sm-4 col-md-12">
                        ...
                        <div class="row">
                            <div class="col-sm-5 col-lg-6">
                                <div class="product-main-image">
                                    <img src='<?php echo base_url('assets/theme/images/product/product-big-1.jpg')?>' alt="" />
                                </div>
                            </div>
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrapper">
                                        ...
                                        <ul class="options-swatch-texture">
                                            <li><a href="#"><img src="<?php echo base_url('assets/theme/images/custom/texture-img-01.jpg')?>" alt=""></a></li>
                                            <li><a href="#"><img src="<?php echo base_url('assets/theme/images/custom/texture-img-02.jpg')?>" alt=""></a></li>
                                            <li><a href="#"><img src="<?php echo base_url('assets/theme/images/custom/texture-img-03.jpg')?>" alt=""></a></li>
                                        </ul>
                                    </div>
                                    <div class="wrapper">
...
<!-- /modalWishlist --><script type="text/javascript" src="<?php echo base_url('assets/theme/external/jquery/jquery-2.1.4.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/bootstrap/bootstrap.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/countdown/jquery.plugin.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/countdown/jquery.countdown.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/slick/slick.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/rs-plugin/js/jquery.themepunch.tools.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/rs-plugin/js/jquery.themepunch.revolution.min.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/external/panelmenu/panelmenu.js')?>"></script>
<script  type="text/javascript" src="<?php echo base_url('assets/theme/js/quick-view.js')?>"></script>
